//Run command to compile: gcc test.c -o test
/*
__author__ = "Mpho Mphego"
__description__ = "Raspberry Pi(master) I2C Arduino(slave) [setup]"
__version__ = "$Revision: 1.0 $"
__date__ = "$Date: 2014/12/28 22:23 $"
...
// The I2C bus:
//static const char *devName = "/dev/i2c-0"; //For V1 Model B you need i2c-0
static const char *devName = "/dev/i2c-1"; // This is for V2 pi's. 
