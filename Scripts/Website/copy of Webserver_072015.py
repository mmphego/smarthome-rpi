...
<meta http-equiv="refresh" content ="300; url = http://172.18.20.41:8000/"  charset="UTF-8">
<TITLE>Mpho's Home Automation Control Center</TITLE>
<link rel="stylesheet" href="http://172.18.20.41/Images/css/style.css" media="screen" type="text/css" />
...
<span id="Header" style="float:left;height:140px;width:1760px;font-size: 20pt">
        <img src="http://172.18.20.41/Images/download.jpg" width="650" height="135" class ="Image">
...
<script src='http://172.18.20.41/Images/js/jquery.js'></script>
<script src="http://172.18.20.41/Images/js/index.js"></script>

<span id="Room Temp" style="height:290px;width:590px;">
	<img src="http://172.18.20.41:8080/render/?width=586&height=290&_salt=1420028512.521&yMax=30&minorY=4&lineMode=connected&fgcolor=FFFFFF&bgcolor=000000&colorList=green%2Cred&title=Room%20Temp&from=-9hours&lineWidth=2&fontSize=12&target=rpi.data.roomTemp&vtitle=Temperature(C)&hideLegend=true" class ="Image">
	</span>
...
<span id="Netwrk Bandwidth" style="height:180px;width:820px;">
