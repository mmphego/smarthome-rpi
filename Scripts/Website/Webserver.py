...
<meta http-equiv='refresh' content ='300; url = http://0.0.0.0:8000/'  charset='UTF-8'>
<TITLE>Mpho's Home Automation Control Center</TITLE>
<link rel='stylesheet' href='http://0.0.0.0/Images/css/style.css' media='screen' type='text/css' />
<style type='text/css'></style></head>

<body background='http://{}/Images/stars.jpg';>
        <style>
        h1{
        color:white;
...
<span id='Header' style='float:left;height:140px;width:1760px;font-size: 20pt'>
        <img src='http://0.0.0.0/Images/download.jpg' width='650' height='135' class ='Image'>
...
<span id='Arduino Int Temp' style='height:290px;width:590px;border:2px solid #a1a1a1'>
        <img src='http://0.0.0.0:8080/render/?width=586&height=290&yMin=50&yMax=&lineMode=connected&hideLegend=true&bgcolor=000000&fgcolor=FFFFFF&minorY=4&title=Arduino%20Internal%20Temp&from=-9hours&fontSize=12&target=rpi.data.internalTemp' class ='Image'>
        </span>
...
<script src='http://0.0.0.0/Images/js/jquery.js'></script>
<script src='http://0.0.0.0/Images/js/index.js'></script>

<span id='Room Temp' style='height:290px;width:590px;'>
        <img src='http://0.0.0.0:8080/render/?width=586&height=290&_salt=1420028512.521&yMax=30&minorY=4&lineMode=connected&fgcolor=FFFFFF&bgcolor=000000&colorList=green%2Cred&title=Room%20Temp&from=-9hours&lineWidth=2&fontSize=12&target=rpi.data.roomTemp&vtitle=Temperature(C)&hideLegend=true' class ='Image'>
        </span>


<span id='RPi Temperature' style='height:290px;width:590px;'>
        <img src='http://0.0.0.0:8080/render/?width=586&height=290&_salt=1419628583.929&minorY=4&from=-9hours&connectedLimit=&fgcolor=FFFFFF&bgcolor=000000&lineWidth=2&title=RPi%20Temp&hideLegend=true&yMax=&fontSize=12&areaMode=first&lineMode=connected&drawNullAsZero=false&graphOnly=false&yStep=&colorList=green&target=rpi.data.internalRPiTemp' class='Image'>
        </span>
...
<p><center>
        <TABLE>
            <TR><TD>Kitchen Light       <TD><button type='submit' style='background-color:rgba(255,255,255,0.0); border:none;' name='led1' value='Led 1'>
                <img src='http://0.0.0.0/Images/on.jpg' width='30' height='30' class ='Image' /></button>
...
<span id='RPi CPU Usage' style='height:290px;width:590px;'>
        <img src='http://0.0.0.0:8080/render/?width=586&height=290&from=-9hours&fgcolor=FFFFFF&bgcolor=000000&fontSize=13&title=RPi%20CPU&minorY=4&connectedLimit=&hideLegend=true&lineMode=connected&areaMode=stacked&target=carbon.rpi.system.loadAvg_15min&target=carbon.rpi.system.loadAvg_5min&target=carbon.rpi.system.loadAvg_1min' class ='Image'>
        </span>

</body>
<span id='Network Bandwidth' style='height:180px;width:820px;'>
        <img src='http://0.0.0.0:8080/render/?width=810&height=180&_salt=1419807028.849&fgcolor=000000&bgcolor=FFFFFF&hideLegend=true&minorY=4&title=Network%20Speed&from=-9hours&target=collectd.graph_host.interface-eth0.if_packets.rx&target=collectd.graph_host.interface-eth0.if_packets.tx&lineMode=connected&areaMode=stacked' width='815' height='175' class ='Image'>
        </span>

<span id='Weather' style='height:180px;width:820px;'>
<img src='http://0.0.0.0/Images/weather.png' width='815' height='180' class='Image'>
</span>
<script>
...
def application(environ, start_response):
   ...
   try:
        ...
        pass #raise RuntimeError ('Runtime error')
   htmls = html.replace('0.0.0.0', host)
   response_body = htmls
   status = '200 OK'
