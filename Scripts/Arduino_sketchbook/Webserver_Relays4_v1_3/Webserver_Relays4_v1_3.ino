      ...
      if (client.available()) {
        ...
        if (readString.length() < 100) {
  	   ...
  	   //client.println("Refresh: 5");  // refresh the page automatically every 5 sec
           ...
           client.println("<html>");
           client.println("<HEAD> ");
           client.println("<meta http-equiv='refresh' content ='59' > ");
           ...
           client.println("<link rel='stylesheet' type='text/css' href='http://172.18.30.110/ethernetcss.css' />");
         ...
         //  client.println("<br />");  
           ...
           //client.println("<p>Created by Mpho Mphego. Visit http://mpho112.wordpress.com for more projects!</p>");  
           client.println("<br />"); 
           client.println("</BODY>");
           client.println("</HTML>");
